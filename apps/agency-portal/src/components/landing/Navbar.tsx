  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between" style={{ padding: "18px clamp(20px, 5vw, 56px)" }}>
          ...
          <div className="hidden md:flex items-center" style={{ gap: 12 }}>
            <Link href="/auth/login" style={{ textDecoration: "none" }}>
              <span className="btn-pill-outline-agency">Sign In</span>
            </Link>
            <Link href="/auth/register" style={{ textDecoration: "none" }}>
              <span className="btn-pill-gold-agency">Register Your Agency</span>
            </Link>
          </div>
          ...
          <div className="md:hidden" style={{ padding: "0 20px 24px", display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 12 }}>
              <Link href="/auth/login" style={{ textDecoration: "none", flex: 1 }}>
                <span className="btn-pill-outline-agency" style={{ display: "block", textAlign: "center" }}>
                  Sign In
                </span>
              </Link>
              <Link href="/auth/register" style={{ textDecoration: "none", flex: 1 }}>
                <span className="btn-pill-gold-agency" style={{ display: "block", textAlign: "center" }}>
                  Register
                </span>
              </Link>
            </div>
      ...
      <style>{`
        ...
        .agency-nav-link:hover { color: #FFFFFF !important; }
        .btn-pill-outline-agency {
        ...
        .btn-pill-outline-agency:hover { background: rgba(255,255,255,0.12); }
        .btn-pill-gold-agency {
          display: inline-flex; align-items: center; justify-content: center;
        ...
        .btn-pill-gold-agency:hover { background: #b89a6f; }
      `}</style>
    </>
  );
}
