      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13.5, color: "rgba(255,255,255,0.5)", margin: 0, maxWidth: 360 }}>
            The digital home for Uzbekistan&rsquo;s local guides, hosts, and artisans.
          </p>
        </div>

        <nav className="flex flex-wrap items-center" style={{ gap: 24 }}>
          <a href="#features" style={{ fontSize: 13.5, color: "rgba(255,255,255,0.65)", textDecoration: "none" }}>Features</a>
          ...
          <Link href="/auth/register" style={{ fontSize: 13.5, color: "#C5A880", textDecoration: "none", fontWeight: 600 }}>Become a Provider</Link>
        </nav>
