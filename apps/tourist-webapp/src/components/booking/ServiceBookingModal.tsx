...
export function ServiceBookingModal({ serviceId, price, currency, maxGuests }: ServiceBookingModalProps) {
  ...
  return (
    <>
      ...
      <Modal open={isOpen} onOpenChange={handleOpenChange} title="Book This Experience">
