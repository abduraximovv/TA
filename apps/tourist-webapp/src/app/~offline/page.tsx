      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-md w-full flex flex-col items-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-500">
            Please check your internet connection to continue exploring UzTour.
          </p>
        </div>
        
        <button 
          onClick={() => window.location.reload()} 
          className="mt-4 px-6 py-2 bg-emerald-950 text-white font-medium rounded-lg hover:bg-primary/90 transition-colors"
        >
          Try Again
        </button>
      </div>
