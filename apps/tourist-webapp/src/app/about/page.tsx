  ...
  return (
    <main className="min-h-[80vh] flex flex-col items-center justify-center bg-sand-50 p-6">
      <div className="bg-white rounded-3xl p-10 md:p-16 max-w-2xl w-full text-center shadow-sm border border-gray-100 flex flex-col items-center">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-dark-graphite mb-4">About Travelora</h1>
        <p className="text-gray-500 mb-8 max-w-md">
          We are passionate about creating unforgettable travel experiences. Our full company story is being written right now and will be published soon.
        </p>
        <Link 
          href="/" 
